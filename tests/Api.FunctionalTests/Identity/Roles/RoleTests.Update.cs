...
{
    [Fact]
    public async Task Update_Should_ReturnNotFound_WhenRoleNotExists()
    {
        // Arrange
    ...
    [Fact]
    public async Task Update_Should_ReturnNotAllowed_WhenRoleIsAdmin()
    {
        // Arrange
    ...
    [Fact]
    public async Task Update_Should_UpdateRole_WhenValid()
    {
        // Arrange
    ...
    //[Fact]
    //public async Task Update_Should_UpdateRoleWithPermissionsBasic_WhenValid()
    //{
    //    // Arrange
    //    var role = new AppRole(Guid.NewGuid().ToString(), "Test role");
    //    await DbContext.Roles.AddAsync(role);
